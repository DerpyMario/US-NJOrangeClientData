...
def procCrawl(dst, src, ldr = None, ls = None):
    ...
    for t in [
        ...
        _run(CddLdr("GameData.bin", DOMAIN + "download14/orange/2/Designs/OrangeData.bin").crawl, dst, src, DOMAIN + "325/Designs/", gHdr),
        _run(CddLdr("TextData.bin", DOMAIN + "download14/orange/2/Designs/OrangeTextData.bin").crawl, dst, src, DOMAIN + "325/Designs/", gHdr),
        _run(CddLdr("ExGameData.bin", DOMAIN + "download14/orange/ExOrangeData.bin").crawl, dst, src, DOMAIN, gHdr),
        _run(CddLdr("ExTextData.bin", DOMAIN + "download14/orange/ExOrangeTextData.bin").crawl, dst, src, DOMAIN, gHdr),
