...
# =============================================================================
PROTOCOL = "http"
ORIGIN = "rockman-cdn.nebulajoy.com/cn/"
...
def procCrawl(dst, src, ldr = None, ls = None):
    ...
    os.makedirs(dst, exist_ok = True)
    for t in [
        _run(AbcLdr("abconfig").crawl, dst, src, DOMAIN + "obt_1_1_0//1/AssetBundlesEncrypt/Android/", gHdr),
        _run(AfiLdr("audiofileinfo").crawl, dst, src, DOMAIN + "obt_1_1_0//1/CriWare/Android/Assets/StreamingAssets/", gHdr),
        _run(JsonLdr("localizationfileinfo").crawl, dst, src, DOMAIN + "obt_1_1_0//1/Localization/", gHdr),
        _run(JsonLdr("RelayParam").crawl, dst, src, DOMAIN + "obt_1_1_0//1/CriWare/Android/Assets/StreamingAssets/", gHdr),
        _run(CddLdr("GameData.bin", DOMAIN + "obt_1_1_0//1/Designs/OrangeData.bin").crawl, dst, src, DOMAIN + "orange//1/Designs/", gHdr),
        _run(CddLdr("TextData.bin", DOMAIN + "obt_1_1_0//1/Designs/OrangeTextData.bin").crawl, dst, src, DOMAIN + "orange//1/Designs/", gHdr),
        _run(CddLdr("ExGameData.bin", DOMAIN + "obt_1_1_0//ExOrangeData.bin").crawl, dst, src, DOMAIN, gHdr),
        _run(CddLdr("ExTextData.bin", DOMAIN + "obt_1_1_0//ExOrangeTextData.bin").crawl, dst, src, DOMAIN, gHdr),
        _run(JsonLdr("cn.1.1.0.bin").crawl, dst, src, DOMAIN, gHdr),
        _run(NullLdr("forbiddenInfo.json").crawl, dst, src, DOMAIN + "obt_1_1_0//1/Designs/", gHdr),
        _run(NullLdr("ORANGE_SOUND.acf").crawl, dst, src, DOMAIN + "obt_1_1_0//1/CriWare/Android/Assets/StreamingAssets/", gHdr),
        _run(NullLdr("Android").crawl, dst, src, DOMAIN + "obt_1_1_0//1/AssetBundlesEncrypt/Android/", gHdr),
        _run(NullLdr("Android.manifest").crawl, dst, src, DOMAIN + "obt_1_1_0//1/AssetBundlesEncrypt/Android/", gHdr)
    ]: t.join()
